...
class Simple2D(Environment):
    ...
    plot_trajectory(self, history_data=None, ax=None):
        Plot the Trajectory of the agent in the environment. In addition to
        environment class.
    ...
    _create_custom_walls(self):
        Custom walls method. In this case is empty since the environment is a simple
        square room.
    ...
    ----------
    state: ndarray
        Contains the x, y coordinate of the position and head direction of the agent
    ...
    history: list of dicts
        Saved history over simulation steps (action, state, new_state, reward,
        global_steps)
    global_steps: int
    ...
    agent_step_size: float
         Size of the step when executing movement, agent_step_size*global_steps will
         give a measure of the total distance traversed by the agent
    """
    ...
    def __init__(
        ...
        **env_kwargs,
        ...
        agent_step_size: float
            ...
            Agent_step_size * global_step_number will give a measure of the distance
        ...
        # Action are not bounded in this environment since the action is normalized in
        # the step function
    ...
    def step(self, action=None, normalize_step: bool = False):
        ...
        if action is None:
            ...
            new_state, valid_action = self.validate_action(
    ...
    def validate_action(self, pre_state, action, new_state):
        ...
        new_state: (2,) 2d-ndarray
            ...
            stays the same, if the state cross the
