from neuralplayground.arenas import Simple2D, Hafting2008
...
class BasicSargolini2006(Hafting2008):
    ...
    def __init__(self, use_behavioral_data: bool = False, data_path: str = None, recording_index: int = None,
                 environment_name: str = "Sargolini2006", verbose: bool = False, experiment_class=SargoliniDataTrajectory,
                 **env_kwargs):
        super().__init__(use_behavioral_data, data_path, recording_index, environment_name, verbose, experiment_class,
                         **env_kwargs)
