...
from neuralplayground.agents.george_2021_extras.george_2021_model import CHMM, validate_seq
...
class George2021(AgentCore):
    ...
    def update(self):
        ...
        if learning_algo == "EM":
            ...
            convergence = self.chmm.learn_em_T(
                x_train, 
                a_train, 
                n_iter=n_iter, 
            ...
            convergence = self.chmm.learn_viterbi_T(
                x_train, 
                a_train, 
                n_iter=n_iter
            )
