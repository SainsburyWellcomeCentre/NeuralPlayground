...
def parameters():
    ...
    params['n_rollout'] = 20
    params['save_period'] = 40 / params['n_rollout']
    # Saving interval
    ...
    params['n_g_subsampled'] = params['n_g_subsampled'] + params['n_ovc'] if params['separate_ovc'] else [grid + ovc for
                                                                                                          grid, ovc in
                                                                                                          zip(params[
                                                                                                                  'n_g_subsampled'],
                                                                                                              params[
