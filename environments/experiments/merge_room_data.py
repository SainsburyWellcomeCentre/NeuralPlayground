...
class WernleData(object):
    ...
    def _load_data(self):
        ...
        self.spikes_A_B = sio.loadmat(os.path.join(self.data_path, self.inner_path,
                                                   r"Figure 4/spkA_B.mat"))["spkA_B"]
...
if __name__ == "__main__":
    ...
    data.plot_development(n_cells=4, time_interval=(2, 5), skip_every=10)
