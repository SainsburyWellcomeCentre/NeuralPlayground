...
1. Create an environment class to following the template shown in the [arena_Core](https://github.com/ClementineDomine/EHC_model_comparison/blob/main/sehec/arena_core.py) and the [Style Guide](https://github.com/ClementineDomine/EHC_model_comparison/tree/main/documents/style_guide). 
