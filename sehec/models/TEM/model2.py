...
class TEM(BasicInfo):
    def __init__(self, params, model_name="TEM", **mod_kwargs):
    ...
    def obs_to_state(self, x, x_, x_perf, g, d, seq_i, s_vis):
        ...
        # Do full Hebbian matrices update after BPTT truncation
        self.final_hebbian()
