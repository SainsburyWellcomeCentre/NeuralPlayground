...
date = '2023-05-16' # 2020-10-13 run 0 for successful node agent
run = '1'
index = '19999'

# Load the model: use import library to import module from specified path
model_spec = importlib.util.spec_from_file_location("model", '../Summaries/' + date + '/torch_run' + run + '/script/whittington_2020_model.py')
...
# torch.save(list(environments[0]), 'environments')
...
torch.save(environments, 'final_environments')
